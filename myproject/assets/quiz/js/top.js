        ...
        for (var i = 1; i < temp_iOAP.secDetails.length; i++) {
            if (temp_iOAP.secDetails[i].isOptional == 'N' || (temp_iOAP.secDetails[i].isOptional == 'Y' && temp_iOAP.secDetails[i].isSelected)) {
                ...
                if (temp_iOAP.isTypingGroup) {
                    ...
                    qtr += "<tr><th width='20%'>" + "<a style=\"cursor:pointer;color:#0000ff\" onclick=\"window.open('http://mockat.com/solution/"+ques.quesID+"/','Answer with explaination','width=1000,height=600')\">"+j+"</a>"+"</th><th width='10%'>" + ques.answer + "</th><th width='10%'>" + ques.quesAnsStatus + "</th><th width='10%'>" + obtainedMarks + "</th></tr>";
                    }
                    qtr += "</table>";
